...
const BookRentCard = ({ book }) => {
  ...
  return (
    <div className="card w-[280px] h-[350px] bg-base-100 shadow-xl border-2 p-4 mr-10  border-b-[#cab956] border-l-[#cab956]">
      <figure className="px-10 pt-10 transition-transform duration-300 transform hover:scale-110">
